...
namespace Capstones.UnityEditorEx
{
    ...
    public static class ShaderVariantAutoCollect
    {
        ...
        {
            var resmanagerasmdefpath = UnityEditor.Compilation.CompilationPipeline.GetAssemblyDefinitionFilePathFromAssemblyName(typeof(CapsModEditor).Assembly.GetName().Name);
            var mod = CapsModEditor.GetAssetModName(resmanagerasmdefpath);
            string pre = "Assets";
