...
public class MultipleVideoPlayerManager : MonoBehaviour, IPointerClickHandler
{
    ...
    private static MultipleVideoPlayerManager instance;
    public static MultipleVideoPlayerManager GetInstance()
    {
        return instance;
    }
    ...
    public void Init()
    {
        ...
        _targetRenderTexture.name = "MultipleVideoPlayerManager";
    ...
    public void SetVideoPath(VideoClip source)
    {
    ...
    private void Awake()
    {
        ...
        if (CheckPlayVideo())
        {
            //if (GLog.IsLogInfoEnabled) GLog.LogInfo("MultipleVideoPlayerManager Awake 最低不是最低处理机型 [" + QualityManager.GetLevel() + " ] [ " + MinimumAdaptation + " ]");
