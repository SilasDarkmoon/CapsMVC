...
namespace Lua.UI
{
    ...
    public class ScrollRectExSameSize : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        void Reset()
        {
            ...
            InitConfig();
            if (string.IsNullOrEmpty(GetComponent<CapsUnityLuaBehav>().InitLuaPath))
            {
                GetComponent<CapsUnityLuaBehav>().InitLuaPath = "ui.control.scroll.LuaScrollRectExSameSize";
            }
            isShowLine = false;
